...
const getBooksbystudentid = async (req, res) => {
    ...
    try {
        ...
        var sql = 'select books.*,studentbook.studentName from books ,studentbook where studentbook.bookRecordId = books._id and studentbook.studentRecordId = ' + bookRecordId
